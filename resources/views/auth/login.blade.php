        ...
        <div class="md:w-4/12  bg-white p-6 rounded-lg shadow-lg">
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="password" id="password" name="password" placeholder="Tu password" class="border p-3 w-full rounded-lg @error('password') border-red-500 @enderror">
                    @error('password')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <input type="submit" value="Iniciar sesion" class="bg-sky-600 hover:gb-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
